...
The script runs the project checks, creates the static Nuxt build with the production API
base, validates the output, switches `/var/www/piloproject` atomically, checks the public

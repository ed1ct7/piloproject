...
const homeFaq = [
  ...
  },
  {
    ...
    answer: 'Позвоните или напишите в MAX: назовите материал, сечение, длину и объём в кубометрах или штуках. Менеджер сверит наличие и посчитает стоимость. Заказ считается подтверждённым после его звонка, оплата — по факту отгрузки. Продаём оптом и в розницу.',
  },
  {
    question: 'Делаете ли сушку, строгание и огнебиозащиту?',
    answer: 'Да, всё на своей площадке: камерная сушка, строгание и огнебиозащитная обработка при отгрузке партии. Доплата за обработку — 2 000 ₽/м³ к цене доски естественной влажности; сухую доску с огнебиозащитой считаем по запросу.',
  },
]
...
useSchemaOrg([
  ...
  ...homeFaq.map((item) => defineQuestion({
    name: item.question,
    ...
    <section class="home-faq" aria-labelledby="home-faq-title">
      <header class="section-heading section-heading--gallery">
        <div>
          ...
          <h2 id="home-faq-title">Что спрашивают перед заказом</h2>
        </div>
        <NuxtLink class="text-link" to="/kontakty">Контакты и проезд</NuxtLink>
      </header>
...
/* Вопросы и ответы внизу главной — на кремовом фоне после галереи на paper */
.home-faq {
  padding: 112px max(24px, calc((100vw - 1320px) / 2));
  border-top: 1px solid var(--color-ink);
  background: var(--color-cream);
